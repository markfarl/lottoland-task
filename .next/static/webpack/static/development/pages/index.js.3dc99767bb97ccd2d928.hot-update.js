...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function niceDateTime(date) {
      console.log(date);
      var d = new Date(date.year + '-' + date.month + '-' + this.twoNum(date.day) + 'T' + this.twoNum(date.hour) + ':' + this.twoNum(date.minute) + ':00.000Z');
...
//# sourceMappingURL=index.js.3dc99767bb97ccd2d928.hot-update.js.map