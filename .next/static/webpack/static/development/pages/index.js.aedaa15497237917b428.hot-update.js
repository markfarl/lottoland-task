...
/* harmony import */ var _scss_icon_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../scss/icon.scss */ "./scss/icon.scss");
/* harmony import */ var _scss_icon_scss__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_scss_icon_scss__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../scss/daxline-pro.scss */ "./scss/daxline-pro.scss");
/* harmony import */ var _scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_15__);
...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function niceDateTime(date) {
      var d = new Date(date.year + '-' + date.month + '=' + date.day);
      return moment__WEBPACK_IMPORTED_MODULE_2___default()(d).format('ddd, DD MMM YYYY at HH:MM');
    }
  }, {
    key: "checkArrayEmpty",
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default.a.when(jquery__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
        ...
        _this2.setState({
          ...
          keno247: {
            ...
            drawingDate: _this2.niceDate(result.keno247.last.date)
          },
          megaMillions: {
            ...
            drawingDate: _this2.niceDateTime(result.megaMillions.last.date)
          }
        });
      });
    }
...
//# sourceMappingURL=index.js.aedaa15497237917b428.hot-update.js.map