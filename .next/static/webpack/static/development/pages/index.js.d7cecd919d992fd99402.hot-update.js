  ...
  _createClass(Kenoland, [{
    ...
    value: function calculate() {
      ...
      if (timeRemaining >= 0) {
        ...
        this.setState({
          time: ("0" + this.state.minutes).slice(-2) + " : " + ("0" + this.state.seconds).slice(-2)
        });
      } else {
        return;
      }
...
//# sourceMappingURL=index.js.d7cecd919d992fd99402.hot-update.js.map