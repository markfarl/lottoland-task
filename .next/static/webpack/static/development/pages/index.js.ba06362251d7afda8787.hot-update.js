...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function niceDate(date) {
      var d = new Date(date.year.toFixed(4) + '-' + date.month.toFixed(2) + '-' + date.day.toFixed(2) + 'T00:00:00.000Z');
    ...
    value: function niceDateTime(date) {
      console.log(date);
      var d = new Date(date.year.toFixed(4) + '-' + date.month.toFixed(2) + '-' + date.day.toFixed(2) + 'T' + date.hour.toFixed(2) + ':' + date.minute.toFixed(2) + ':00.000Z');
...
//# sourceMappingURL=index.js.ba06362251d7afda8787.hot-update.js.map