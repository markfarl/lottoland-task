...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function niceDate(date) {
      var d = new Date(date.year + '-' + twoNum(date.month) + '-' + twoNum(date.day) + 'T00:00:00.000Z');
    ...
    value: function niceDateTime(date) {
      console.log(date);
      var d = new Date(date.year + '-' + date.month + '-' + twoNum(date.day) + 'T' + twoNum(date.hour) + ':' + twoNum(date.minute) + ':00.000Z');
...
//# sourceMappingURL=index.js.2cb8514549f23397096b.hot-update.js.map