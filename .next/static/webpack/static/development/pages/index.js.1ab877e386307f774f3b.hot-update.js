...
/* harmony import */ var _scss_icon_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../scss/icon.scss */ "./scss/icon.scss");
/* harmony import */ var _scss_icon_scss__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_scss_icon_scss__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../scss/daxline-pro.scss */ "./scss/daxline-pro.scss");
/* harmony import */ var _scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_scss_daxline_pro_scss__WEBPACK_IMPORTED_MODULE_13__);
...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    key: "checkArrayEmptyAndSplit",
    value: function checkArrayEmptyAndSplit(array) {
      if (array) {
        var a = array[0].toString();
        console.log(a);
        var b = a.split('');
        return b;
      } else {
    ...
    value: function getDrawingApi() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default.a.when(jquery__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
        ...
        _this2.setState({
          ...
          worldMillions: {
            numbers: _this2.checkArrayEmptyAndSplit(result.worldMillions.last.numbers),
...
//# sourceMappingURL=index.js.1ab877e386307f774f3b.hot-update.js.map